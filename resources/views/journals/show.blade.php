           ...
           <div class="container rounded-0">
            <div class="row">
              <div class="col-lg-3 order-lg-1 mb-4">
                ...
                <!-- Components -->
                <div class="list-group list-group-transparent mb-0">
                  <a href="{{route('journals.admin.index')}}" class="list-group-item list-group-item-action"><span class="icon mr-3"><i class="fe fe-file"></i></span>View all Journals</a>
                  <a href="{{route('journals.edit', $journal->id)}}" class="list-group-item list-group-item-action"><span class="icon mr-3"><i class="fe fe-edit-2"></i></span>Edit</a>
                </div>
              </div>
              <div class="col-lg-9">
                <div class="card">
