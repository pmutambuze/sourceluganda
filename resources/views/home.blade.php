              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    ...
                    <div class="text-muted mb-4">Journals</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    ...
                    <div class="text-muted mb-4">Un published Journals</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    ...
                    <div class="text-muted mb-4">Published Journals</div>
                  </div>
                </div>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
              ...
              <div class="col-6 col-sm-4 col-lg-2">
                <div class="card">
                  <div class="card-body p-3 text-center">
                    ...
                    <div class="text-muted mb-4">Members</div>
                  </div>
                </div>
              </div>
            </div>
